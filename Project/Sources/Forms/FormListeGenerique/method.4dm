Case of 
	: (Form event code:C388=Sur chargement:K2:1)
		...
		OBJECT SET COORDINATES:C1248(*; "List Box"; 20; 20; 320+(285*(Form:C1466.column.length-1)))
		...
		If ($gaucheCalcul_el<0)  // La Fenêtre va être plus large que la largeur de l'écran...
			$droiteCalcul_el:=Screen width:C187(*)-Abs:C99($gaucheCalcul_el)
		Else 
			$droiteCalcul_el:=((Screen width:C187(*)/2)-10)+($largeurForm_el/2)
		End if 
		
		
		SET WINDOW RECT:C444(Abs:C99($gaucheCalcul_el); $haut_el; $droiteCalcul_el; $bas_el; Frontmost window:C447; *)
End case 